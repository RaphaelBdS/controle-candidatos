...
public class ProcessoSeletivo {
    ...
    static void entrandoEmContato(String candidato) {
        ...
        if (atendeu)
            ...
            System.out.println("NAO CONSEGUIMOS CONTATO COM " + candidato + ", NUMERO MAXIMO DE TENTAIVAS "
    ...
    static void imprimirSelecionados() {
        String[] candidatos = { "FELIPE", "MÁRCIA", "JULIA", "PAULO", "AUGUSTO" };
        System.out.println("Imprimindo a liista de candidatos informando o indice do elemento");
